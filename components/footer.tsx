      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid gap-10 sm:gap-12 md:grid-cols-3 lg:grid-cols-4">
          ...
          <nav aria-label="Páginas" className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link className="text-muted-foreground transition-colors hover:text-foreground" href="#precos">Preços</Link>
              </li>
            </ul>
          </nav>
          ...
          <nav aria-label="Informações" className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link className="text-muted-foreground transition-colors hover:text-foreground" href="#planos">Planos</Link>
              </li>
              <li>
        ...
        <div className="mt-10 flex flex-col-reverse items-start justify-between gap-6 border-t border-border/60 pt-8 sm:flex-row sm:items-center">
          <p className="text-xs text-muted-foreground">
            © {year} TymerBook. Todos os direitos reservados.
          </p>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="Instagram da TymerBook"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook da TymerBook"
              className="text-muted-foreground transition-colors hover:text-foreground"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube da TymerBook"
              className="text-muted-foreground transition-colors hover:text-foreground"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn da TymerBook"
              className="text-muted-foreground transition-colors hover:text-foreground"
            >
