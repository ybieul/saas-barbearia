...
const FEATURES = [
  {
    ...
    desc:
      "Conecte e organize todas as suas agendas em um só lugar. Múltiplos barbeiros, serviços e horários.",
  },
  {
    icon: Users2,
    title: "Gestão de Clientes",
    desc:
      "Tenha um histórico completo de cada cliente, serviços favoritos, datas de aniversário e anotações importantes.",
  },
  {
    icon: Briefcase,
    title: "Serviços Personalizados",
    desc:
      "Crie e organize sua lista de serviços e adicione categorias para um agendamento rápido e intuitivo.",
  },
  {
    icon: CalendarCheck2,
    title: "Relatórios detalhados",
    desc:
      "Veja o faturamento, os serviços mais vendidos e o desempenho de cada barbeiro.",
  },
  {
    icon: ShieldCheck,
    title: "Seguro e Privado",
    desc:
      "Seus dados e os dados dos seus clientes estão protegidos com criptografia.",
  },
  {
    icon: Lock,
    title: "Limites de Agendamento",
    desc:
      "Defina o tempo de cada serviço e o número de agendamentos por dia. Você no controle.",
  },
];
...
function FeatureCard({ icon: Icon, title, desc }: any) {
  return (
    ...
    >
      {/* camada interna para criar o efeito de moldura com 1px */}
  ...
  return (
    <SectionLayout>
      <div className="mx-auto mb-10 max-w-3xl text-center">
        ...
        <p className="mt-3 text-muted-foreground">Tudo o que você precisa para crescer, em um único lugar.</p>
      </div>
