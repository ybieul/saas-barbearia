		...
		<SectionLayout>
			<div className="grid gap-8 md:grid-cols-2 md:items-center">
				<div className="relative aspect-video w-full overflow-hidden rounded-xl border border-border/60 bg-black">
					<video className="h-full w-full" controls poster={poster} playsInline>
				...
				<div>
					<h3 className="text-2xl md:text-3xl font-bold">Veja na prática como funciona</h3>
					<p className="mt-3 text-muted-foreground">
						Assista a um relato real de quem usa a TymerBook no dia a dia e descubra como a plataforma ajuda a
