...
import { CreditCard, DollarSign, Smartphone, CheckCircle2, User, Scissors, Clock, Receipt, Star, ShoppingCart } from "lucide-react"
import { ProductSelectionModal, type ProductCartItem } from '@/components/ui/product-selection-modal'
...
export function PaymentMethodModal({
  ...
  // A busca e gerenciamento detalhado ficam no sub-modal de produtos
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[#18181b] border-[#27272a] text-[#ededed] w-[calc(100vw-2rem)] max-w-md sm:w-full sm:max-w-md mx-auto h-auto sm:h-auto flex flex-col rounded-xl">
        ...
        {/* Sub-modal de seleção de produtos */}
        {enableProductSelection && (
