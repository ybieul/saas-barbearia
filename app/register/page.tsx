  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Pixel de Conversão: cadastro concluído
        try {
...
fbq('track', 'PageView');
      ...
      <noscript
        dangerouslySetInnerHTML={{
          __html: `
<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=846383871883856&ev=PageView&noscript=1" />
          `,
        }}
      />
