  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#0a0a0a] via-[#18181b] to-[#0a0a0a] p-4">
      ...
      <div className="flex w-full max-w-sm flex-col items-center">
        {/* Logo */}
        <div className="mb-4">
          <AuthLogo className="drop-shadow-[0_0_16px_rgba(139,92,246,0.35)]" sizePreset="default" />
        </div>
        {/* Card do formulário */}
          ...
          <CardContent className="pt-2">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="text-center">
                <Link href="/recuperar-senha" className="text-sm text-[#71717a] transition-colors hover:text-tymer-primary">
                  Esqueceu sua senha?
                </Link>
              </div>
            </form>
