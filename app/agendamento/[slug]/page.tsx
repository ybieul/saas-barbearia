          ...
          <Card className="bg-[#18181b] border-[#27272a] mb-6">
            <CardHeader className="text-center">
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                isDetailsVisible ? 'max-h-96 opacity-100 mt-4' : 'max-h-0 opacity-0'
              }`}>
                  ...
                  <div className="flex justify-center gap-3 mt-4">
                    ...
                    {businessData.businessInstagram && (
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="border-[#27272a] text-[#ededed] hover:border-pink-500 hover:bg-pink-500/10 flex items-center gap-2"
                      >
                        <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
