...
export const manualContent = [
   ...
   "- Agora localizada no final da página de Relatórios & Financeiro.",
   "- Permite cadastrar itens recorrentes (ex.: Aluguel, Energia, Internet, Sistema, Água).",
   "- Cada linha possui Nome, Valor (R$) e botão para remover.",
   "- Botão 'Adicionar' insere novo custo; 'Salvar alterações' persiste a lista para uso futuro.",
   "- Total mensal calculado automaticamente (soma dos itens).",
   "- Dois cards exibidos: Custos Fixos (Mensal) e Lucro Líquido (Estimado, Mês = Receita do mês - Custos Fixos).",
   "- Navegação de mês igual à Análise Mensal para mudar rapidamente o mês analisado.",
   "- Removidos indicadores de variação (setas) para evitar leitura incorreta antes de comparação histórica ser implementada.",
   "- Recomendado incluir apenas despesas recorrentes; revise no início de cada mês.",
   "",
