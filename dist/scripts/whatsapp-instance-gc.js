...
function cleanupOrphanedInstances() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const tenantsWithInstance = yield prisma_1.prisma.tenant.findMany({
                where: {
            ...
            const response = yield fetch(`${EVOLUTION_API_URL}/instance/all`, {
                method: 'GET',
                headers: {
            ...
            const allEvolutionInstances = yield response.json();
            ...
            for (const evolutionInstance of allEvolutionInstances) {
                const instanceName = (_a = evolutionInstance.instance) === null || _a === void 0 ? void 0 : _a.instanceName;
                if (!instanceName) {
